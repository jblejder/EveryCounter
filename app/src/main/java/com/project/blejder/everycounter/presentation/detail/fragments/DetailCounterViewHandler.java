...
import com.project.blejder.everycounter.presentation.detail.viewhandler.DetailCounterHandler;
import com.project.blejder.everycounter.presentation.list.fragments.ListCountersFragment;
import com.project.blejder.everycounter.presentation.shared.fragments.BaseViewHandler;
import com.project.blejder.everycounter.presentation.shared.fragments.dialog.TextEditDialog;
...
class DetailCounterViewHandler extends BaseViewHandler<DetailCounterFragment>
    ...
    public void openList() {
        perform(ref -> ref.getNavigator().openFragment(ListCountersFragment.newInstance()));
    }
